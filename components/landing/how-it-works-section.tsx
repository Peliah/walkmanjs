          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-12 left-full w-full h-px bg-border -translate-x-4" />
              )}

              <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                <motion.div
                  whileHover={{ scale: 1.1 }}
                  className="w-24 h-24 rounded-full border-2 border-primary flex items-center justify-center mb-6 bg-primary/5"
                >
                ...
                {step.code && (
                  <div className="w-full rounded-lg bg-foreground text-primary-foreground p-4 font-mono text-xs overflow-x-auto">
                    <code>{step.code}</code>
                  </div>
                )}
              </div>
